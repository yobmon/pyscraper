...
class TestCrawl(unittest.TestCase):
    ...
    def test_get_urls_html_absolute(self):
        input_url = "https://blog.root.et"
        input_body = '<html><body><a href="https://blog.boot.dev"><span>Boot.dev></span></a></body></html>  <html><body><a href="https://blog.boot.dev"><span>Boot.dev></span></a></body></html>'
        actual = get_urls_html(input_body, input_url)
        expected = ["https://blog.root.et","https://blog.boot.dev"]
        self.assertEqual(actual, expected)
